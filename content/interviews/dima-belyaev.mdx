...
<PullQuote>
I start by writing a snippet of how the library or component should be used in the product… then I start ‘making it worse’ by introducing real-world limitations and requirements.
</PullQuote>
...
<PullQuote>
At scale, you might think you’ve covered every possible use case for a component but trust me, you haven’t… Give people an easy way to combine smaller pieces of the UI instead of building huge, all-in-one components.
</PullQuote>
